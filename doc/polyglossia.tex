...
\begin{tabular}{lllll}
\hline
albanian       & danish         & interlingua    & nynorsk        & \TX{syriac}   \\
amharic        & divehi         & irish          & occitan        & tamil         \\
\TX{arabic}    & \TX{dutch}     & \TX{italian}   & piedmontese    & telugu        \\
armenian       & \TX{english}   & kannada        & polish         & \TX{thai}     \\
asturian       & \TX{esperanto} & khmer          & portuges       & tibetan       \\
bahasai        & estonian       & korean         & romanian       & turkish       \\
bahasam        & \TX{farsi}     & \TX{lao}       & romansh        & turkmen       \\
basque         & finnish        & \TX{latin}     & \TX{russian}   & \TX{ukrainian}\\
\TX{bengali}   & french         & latvian        & samin          & urdu          \\
brazil[ian]    & friulan        & lithuanian     & \TX{sanskrit}  & \TX{usorbian} \\
breton         & galician       & \TX{lsorbian}  & scottish       & vietnamese    \\
bulgarian      & \TX{german}    & \TX{magyar}    & \TX{serbian}   & welsh         \\
\TX{catalan}   & \TX{greek}     & malayalam      & slovak         &               \\
coptic         & \TX{hebrew}    & marathi        & slovenian      &               \\
croatian       & \TX{hindi}     & nko            & spanish        &               \\
czech          & icelandic      & norsk          & swedish        &               \\
\hline
\end{tabular}
