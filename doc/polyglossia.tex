...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgboolkeytrue[1.53]{swapcaptions}
	In Uyghur, table and figure caption strings need to be in a different order and format than in other languages.
	By default, \pkg{polyglossia} provides the correct form.
	You can reset to \LaTeX\ default by setting this option to false.
\end{itemize}
...
\begin{itemize}
	...
	\item Fix Uyghur caption format and add \xpgoption{swapcaptions} option (\TXI{479}).
