...
\begin{tabular}{lllll}
\hline
albanian     & \TX{english}   & japanese       & \TX{persian}   & tamil          \\
amharic      & \TX{esperanto} & kannada        & piedmontese    & telugu         \\
\TX{arabic}  & estonian       & khmer          & polish         & \TX{thai}      \\
\TX{armenian}& \TX{finnish}   & \TX{korean}    & \TX{portuguese}& \TX{tibetan}   \\
asturian     & \TX{french}    & \TX{kurdish}   & romanian       & turkish        \\
basque       & friulian       & \TX{lao}       & romansh        & turkmen        \\
\TX{bengali} & \TX{gaelic}    & \TX{latin}     & \TX{russian}   & \TX{ukrainian} \\
breton       & galician       & latvian        & \TX{sami}      & urdu           \\
bulgarian    & \TX{german}    & lithuanian     & \TX{sanskrit}  & vietnamese     \\
\TX{catalan} & \TX{greek}     & macedonian     & \TX{serbian}   & \TX{welsh}     \\
coptic       & \TX{hebrew}    & \TX{malay}     & slovak         &                \\
croatian     & \TX{hindi}     & malayalam      & \TX{slovenian} &                \\
czech        & hungarian      & marathi        & \TX{sorbian}   &                \\
danish       & icelandic      & nko            & spanish        &                \\
divehi       & interlingua    & \TX{norwegian} & swedish        &                \\
\TX{dutch}   & \TX{italian}   & occitan        & \TX{syriac} \\
\hline
\end{tabular}
