...
\begin{itemize}
\item Add support for Odia, provided by \TA{Abhisek Jena}.
...
since we took over.
In alphabetical order: \TA{Abhisek Jena}, \TA{Ignas Anikevicius}, \TA{Sina Ahmadi}, \TA{Wouter Bolsterlee}, \TA{Christian Buhtz},
