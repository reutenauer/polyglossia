...
\begin{tabular}{lllll}
\hline
               & danish         & interlingua    & marathi        & spanish     \\
albanian       & divehi         & irish          & nko            & swedish     \\
amharic        & \TX{dutch}     & \TX{italian}   & \TX{norwegian} & \TX{syriac} \\
\TX{arabic}    & \TX{english}   & japanese       & occitan        & tamil       \\
\TX{armenian}  & \TX{esperanto} & kannada        & piedmontese    & telugu      \\
asturian       & estonian       & khmer          & polish         & \TX{thai}   \\
bahasai        & \TX{farsi}     & \TX{korean}    & \TX{portuguese}& \TX{tibetan}\\
bahasam        & \TX{finnish}   & \TX{kurdish}   & romanian       & turkish     \\
...
bulgarian      & \TX{german}    & lithuanian     & \TX{sanskrit}  & \TX{usorbian}\\
\TX{catalan}   & \TX{greek}     & \TX{lsorbian}  & scottish       & vietnamese   \\
coptic         & \TX{hebrew}    & \TX{magyar}    & \TX{serbian}   & \TX{welsh}    \\
croatian       & \TX{hindi}     & macedonian     & slovak         &     \\
czech          & icelandic      & malayalam      & \TX{slovenian}\\
\hline
\end{tabular}
