...
\begin{itemize}
	...
	\item Add \cmd{\startbabelshorthands}.
\end{itemize}
...
\begin{itemize}
	\item The package code has been subjected to a major rewrite.
	      ...
	      more consistently employs \pkg{latex3} now.
\end{itemize}
