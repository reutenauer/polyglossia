...
\paragraph*{Options:}
	\begin{itemize}
    \item \xpgboolkeyfalse{fullyear} causes years from the current millenium to be printed with the thousands digit
	...
	\item \xpgchoicekey{transliteration}{\xpgvalue{academy} or \xpgpresetvalue{alt}} With value \xpgvalue{academy}, transliteration
