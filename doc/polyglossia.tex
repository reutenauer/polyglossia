...
\begin{tabular}{lllll}
\hline
albanian     & croatian       & \TX{hebrew}   & nko          & spanish       \\
amharic      & czech          & \TX{hindi}    & norsk        & swedish       \\
\TX{arabic}  & danish         & icelandic     & nynorsk      & \TX{syriac}   \\
armenian     & divehi         & interlingua   & occitan      & tamil         \\
asturian     & \TX{dutch}     & irish         & polish       & telugu        \\
bahasai      & \TX{english}   & \TX{italian}  & portuges     & tibetan       \\
bahasam      & \TX{esperanto} & \TX{lao}      & romanian     & \TX{thai}     \\
basque       & estonian       & latin         & \TX{russian} & turkish       \\
\TX{bengali} & \TX{farsi}     & latvian       & samin        & turkmen       \\
brazil[ian]  & finnish        & lithuanian    & \TX{sanskrit}& ukrainian     \\
breton       & french         & \TX{lsorbian} & scottish     & urdu          \\
bulgarian    & galician       & \TX{magyar}   & \TX{serbian} & \TX{usorbian} \\
\TX{catalan} & \TX{german}    & malayalam     & slovak       & vietnamese    \\
coptic       & \TX{greek}     & marathi       & slovenian    & welsh         \\
\hline
\end{tabular}
