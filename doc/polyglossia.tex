...
\paragraph{Nota bene} Support for Chinese and Japanese is very basic and only a proof of concept. There is yet no line breaking mechanism used with these languages (as opposed to Korean), so unless you implement your own rules, the output is not usable for production. We need volunteers who are familiar with these scripts to finish support. If you can help, please contact us.
...
\begin{itemize}
	...
	\item Remove sporious spaces from Korean and Serbian glosses (\TXI{659}, \TXI{660})
\end{itemize}
