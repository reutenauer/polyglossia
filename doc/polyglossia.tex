...
\paragraph*{Options:}
	...
	\item \xpgcodekey[1.63]{sectionsep}¦.¦
		...
		This might be useful particularly with \xpgoption{numerals=mashriq}, as the dot looks too similar to the zero
		in many fonts.
...
\begin{itemize}
	...
	\item Fix Mashriq Arabic numbering direction with \LuaLaTeX\ (amends previous fix to \TXI{213}).
\end{itemize}
...
\begin{itemize}
	...
	\item New option \xpgoption{sectionsep} for Arabic (\TXI{589}).
\end{itemize}
