...
\begin{tabular}{lllll}
\toprule
\TX{afrikaans} & \TX{dutch}     & \TX{italian}   & \TX{norwegian}  & swedish       \\
albanian       & \TX{english}   & japanese       & occitan         & \TX{syriac}   \\
amharic        & \TX{esperanto} & kannada        & \TX{persian}    & tamil         \\
\TX{arabic}    & estonian       & khmer          & piedmontese     & telugu        \\
\TX{armenian}  & \TX{finnish}   & \TX{korean}    & polish          & \TX{thai}     \\
asturian       & \TX{french}    & \TX{kurdish}   & \TX{portuguese} & \TX{tibetan}  \\
basque         & friulian       & \TX{lao}       & romanian        & turkish       \\
...
divehi         & interlingua    & nko            & \TX{spanish}    &               \\
\bottomrule
\end{tabular}
...
In version 1.46\new{v1.46}, support for Afrikaans has been added.
...
\begin{itemize}
	\item \TB{babelshorthands}\new{v1.1.1} globally activates \pkg{babel}
		...
		Afrikaans, Catalan, Czech, Dutch, Finnish, German, Italian, Latin, Mongolian,
