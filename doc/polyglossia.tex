...
\subsection{Using IETF language tags}
...
(\eg ¦\fi¦) or \cmd{\text⟨...⟩} command (\eg ¦\textit¦), a starred version \Cmd{\setlanguagealias*}
...
where \texttt{⟨lang⟩} is a \pkg{babel} language name, or by
