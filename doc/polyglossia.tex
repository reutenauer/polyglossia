...
\begin{tabular}{lllll}
\toprule
\TX{afrikaans}  & danish         & icelandic    & \TX{mongolian}  & \TX{sorbian}  \\
albanian        & divehi         & interlingua  & nko             & \TX{spanish}  \\
amharic         & \TX{dutch}     & \TX{italian} & \TX{norwegian}  & swedish       \\
\TX{arabic}     & \TX{english}   & japanese     & occitan         & \TX{syriac}   \\
\TX{armenian}   & \TX{esperanto} & kannada      & \TX{persian}    & tamil         \\
asturian        & estonian       & khmer        & piedmontese     & telugu        \\
basque          & \TX{finnish}   & \TX{korean}  & polish          & \TX{thai}     \\
\TX{belarusian} & \TX{french}    & \TX{kurdish} & \TX{portuguese} & \TX{tibetan}  \\
\TX{bengali}    & friulian       & \TX{lao}     & romanian        & turkish       \\
bosnian         & \TX{gaelic}    & \TX{latin}   & romansh         & turkmen       \\
...
In version 1.46\new{v1.46}, support for Afrikaans, Belarusian and Bosnian has been added.
