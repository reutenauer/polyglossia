...
\begin{itemize}
  ...
  \item \xpgboolkeyfalse[1.54]{schoolhyphens}
	    ...
	    default Finnish patterns. These (so-called `School Hyphenation') patterns allow hyphenation at
	    ...
	    are often not being hyphenated at points where this would be valid.
