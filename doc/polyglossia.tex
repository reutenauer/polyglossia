...
\begin{tabular}{lllll}
\hline
albanian     & \TX{dutch}     & \TX{italian}  & occitan        & tamil          \\
amharic      & \TX{english}   & japanese      & piedmontese    & telugu         \\
\TX{arabic}  & \TX{esperanto} & kannada       & polish         & \TX{thai}      \\
\TX{armenian}& estonian       & khmer         & \TX{portuguese}& \TX{tibetan}   \\
asturian     & \TX{farsi}     & \TX{korean}   & romanian       & turkish        \\
\TX{bahasa}  & \TX{finnish}   & \TX{kurdish}  & romansh        & turkmen        \\
basque       & \TX{french}    & \TX{lao}      & \TX{russian}   & \TX{ukrainian} \\
\TX{bengali} & friulan        & \TX{latin}    & \TX{sami}      & urdu           \\
breton       & \TX{gaelic}    & latvian       & \TX{sanskrit}  & vietnamese     \\
bulgarian    & galician       & lithuanian    & \TX{serbian}   & \TX{welsh}     \\
\TX{catalan} & \TX{german}    & \TX{magyar}   & slovak         &                \\
coptic       & \TX{greek}     & macedonian    & \TX{slovenian} &                \\
croatian     & \TX{hebrew}    & malayalam     & \TX{sorbian}   &                \\
czech        & \TX{hindi}     & marathi       & spanish        &                \\
danish       & icelandic      & nko           & swedish        &                \\
divehi       & interlingua    & \TX{norwegian}& \TX{syriac} \\
\hline
\end{tabular}
