...
\begin{tabular}{lllll}
\hline
albanian     & \TX{english}    & japanese      & occitan        & tamil          \\
amharic      & \TX{esperanto}  & kannada       & piedmontese    & telugu         \\
\TX{arabic}  & estonian        & khmer         & polish         & \TX{thai}      \\
\TX{armenian}& \TX{farsi}      & \TX{korean}   & \TX{portuguese}& \TX{tibetan}   \\
asturian     & \TX{finnish}    & \TX{kurdish}  & romanian       & turkish        \\
basque       & \TX{french}     & \TX{lao}      & romansh        & turkmen        \\
\TX{bengali} & friulan         & \TX{latin}    & \TX{russian}   & \TX{ukrainian} \\
breton       & \TX{gaelic}     & latvian       & \TX{sami}      & urdu           \\
bulgarian    & galician        & lithuanian    & \TX{sanskrit}  & vietnamese     \\
\TX{catalan} & \TX{german}     & \TX{magyar}   & \TX{serbian}   & \TX{welsh}     \\
coptic       & \TX{greek}      & macedonian    & slovak         &                \\
croatian     & \TX{hebrew}     & \TX{malay}    & \TX{slovenian} &                \\
czech        & \TX{hindi}      & malayalam     & \TX{sorbian}   &                \\
danish       & icelandic       & marathi       & spanish        &                \\
divehi       & interlingua     & nko           & swedish        &                \\
\TX{dutch}   & \TX{italian}    & \TX{norwegian}& \TX{syriac} \\
\hline
\end{tabular}
