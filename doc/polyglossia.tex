...
\cmd{\textlang\oarg{options}\marg{lang}\{…\}}\new{1.46})
...
\item \DescribeMacro{\foreignlanguage}\cmd{\foreignlanguage\oarg{options}\marg{lang}\{…\}}
...
\paragraph*{Commands:}
  ...
  \item \Cmd\aemph to emphasize text with \cmd\overline.\new{1.2.0}
    \cmd{\textarabic{\aemph{اب}}} yields \textarabic{\aemph{اب}}.
...
\begin{itemize}
  \item \xpgboolkeyfalse{babelshorthands}
	...
	\end{shorthands}
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{arabic} or \xpgvalue{cyrillic}}
...
\begin{itemize}
	...
	\eg \cmd\textbelarusian{{\Asbuk{page}}} produces \textrussian{\Asbuk{page}}.
...
\begin{itemize}
	\item \Cmd\Asbuk: produces uppercased Cyrillic alphanumerals, for
	environments such as ¦enumerate¦. The command takes a counter as argument,
	\eg \cmd{\textmongolian{\Asbuk{page}}} produces \textrussian{\Asbuk{page}}.
	\item \Cmd\asbuk: same in lowercase
\end{itemize}
...
\paragraph*{Commands:}
	...
	\item \Cmd\Asbuk: produces uppercased Cyrillic alphanumerals, for
	environments such as ¦enumerate¦. The command takes a counter as argument,
	\eg \cmd{\textrussian{\Asbuk{page}}} produces \textrussian{\Asbuk{page}}.
	\item \Cmd\asbuk: same in lowercase
	\end{itemize}
