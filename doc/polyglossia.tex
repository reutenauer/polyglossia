...
typing ¦\textarabic{2010}¦ results in \textarabic{٢٠١٠}.

With version v1.1.1\new{v1.1.1} conversions of this kind can also be achieved directly via \TeX\ macros.
This prevents some problems that occur when the value of a counter has to be written and read from
...
Currently, the macros \Cmd\arabicdigits, \Cmd\farsidigits\ and \Cmd\thaidigits\ are provided.
