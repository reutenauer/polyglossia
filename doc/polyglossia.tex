...
\newcommand*\xpgoption[1]{\textcolor{xpgblue}{\bfseries #1}}
\newcommand*\xpgpresetvalue[1]{\textit{#1}}
\newcommand*\xpgdefaultvalue[1]{*#1}
...
\NewDocumentCommand\xpgboolkey{omo}{\xpgchoicekey[#1]{#2}[#3]{\xpgdefaultvalue{true} or false}}
\NewDocumentCommand\xpgboolkeytrue{omo}{\xpgchoicekey[#1]{#2}[#3]{\xpgdefaultvalue{\xpgpresetvalue{true}} or false}}
...
\begin{itemize}
	...
	is marked by a preceding \xpgdefaultvalue{asterisk}.
\end{itemize}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{calendar}{\xpgpresetvalue{gregorian} or islamic (= hijri)}
	...
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{mashriq} or maghrib}
...
\paragraph*{Options:}
\begin{itemize}
  \item \xpgchoicekey[1.45]{variant}{eastern or \xpgpresetvalue{western}}
	\item \xpgchoicekey[1.45]{numerals}{armenian or \xpgpresetvalue{arabic}}
\end{itemize}
...
\begin{itemize}
  \item \xpgboolkeyfalse{babelshorthands}
	...
	\end{shorthands}
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{arabic} or cyrillic}
	Uses either Arabic numerals or Cyrillic	alphanumerical numbering.
	\item \xpgchoicekey{spelling}{\xpgpresetvalue{modern} or classic (= tarask)}
...
\paragraph*{Options:}
	\begin{itemize}
	  \item \xpgchoicekey{numerals}{Western, Bengali, or \xpgpresetvalue{Devanagari}}
...
\begin{itemize}
	...
	\begin{shorthands}
		...
		\item[¦"-¦] adds a hyphenation point that does still allow for hyphenation at the points preset
		            in the hyphenation patterns (as opposed to ¦\-¦).
		\item[¦""¦] allows for a line break at this position (without hyphenation sign).
		\item[¦"/¦] a slash that allows for a subsequent line break. As opposed to ¦\slash¦, hyphenation
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{variant}{\xpgpresetvalue{american} (= us), usmax (same as ‘american’ but with additional hyphenation patterns),
...
\paragraph*{Options:}
	\begin{itemize}
		\item \xpgchoicekey{variant}{\xpgpresetvalue{french} or canadian (=~acadian)\new{1.45}, swiss\new{1.47}}
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey{variant}{\xpgpresetvalue{irish} or scottish}
\end{itemize}
...
\begin{itemize}
	\item \xpgboolkeyfalse{babelshorthands}
		...
		\begin{shorthands}
			...
			\item[¦">¦] for French right double quotes (looks like >>).
		\end{shorthands}
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{arabic} or georgian}
...
\paragraph*{Options:}
	...
	\item \xpgchoicekey{variant}{\xpgpresetvalue{german}, austrian, or swiss\new{1.33.4}}
		...
		patterns.
	\item \xpgchoicekey{spelling}{\xpgpresetvalue{new} (= 1996) or old (= 1901)}
	...
	\item \xpgboolkeyfalse[1.0.3]{babelshorthands}
		...
		\end{shorthands}
	\item \xpgchoicekey[1.2.0]{script}{\xpgpresetvalue{latin} or blackletter\new{1.46} (= fraktur)}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{variant}{\xpgpresetvalue{monotonic} (= mono), polytonic (= poly), or ancient}
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{greek} or arabic}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{numerals}{hebrew or \xpgpresetvalue{arabic}}
	\item \xpgchoicekey{calendar}{hebrew or \xpgpresetvalue{gregorian}}
...
\paragraph*{Options:}
	\begin{itemize}
		\item \xpgchoicekey{numerals}{Western or \xpgpresetvalue{Devanagari}}
	\end{itemize}
...
\paragraph*{Options:}
  \begin{itemize}
	\item \xpgchoicekey{variant}{\xpgpresetvalue{plain}, classic, or modern}
    These variants control spacing before/after CJK punctuations.
      ...
      \end{itemize}
	\item \xpgchoicekey{captions}{\xpgpresetvalue{hangul} or hanja}
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey{variant}{kurmanji or \xpgpresetvalue{sorani}}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{numerals}{lao or \xpgpresetvalue{arabic}}
	\end{itemize}

\subsection{latin}\label{latin}
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey{variant}{classic, medieval, \xpgpresetvalue{modern}, or ecclesiastic\new{1.46}}
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey[1.45]{variant}{\xpgpresetvalue{indonesian} (= bahasai in
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey[1.45]{variant}{bokmal (= `norsk' in \pkg{babel}) or \xpgpresetvalue{nynorsk}}
\end{itemize}

\subsection{persian}\label{persian}
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey{numerals}{western or \xpgpresetvalue{eastern}}
	\item \xpgboolkeyfalse[1.0.3]{abjadjimnotail}
		Set this to true if you want the \textit{abjad} form of the number three to
		be \textarabic{ج‍} – as in the manuscript tradition – instead of the
		modern usage \textarabic{ج}.
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey[1.45]{variant}{brazilian or \xpgpresetvalue{portuguese}}
\end{itemize}
...
%		\item[¦">¦] for French right double quotes (looks like >>).
	...
	\item \xpgchoicekey{spelling}{\xpgpresetvalue{modern} or old}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey[1.0.2]{script}{\xpgpresetvalue{Devanagari}, Gujarati,
	...
	\item \xpgchoicekey[1.45]{numerals}{\xpgpresetvalue{Devanagari} or Western}
	\end{itemize}

\subsection{serbian}\label{serbian}
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{script}{\xpgpresetvalue{Cyrillic} or Latin}
	\item \xpgchoicekey{numerals}{\xpgpresetvalue{arabic} or cyrillic}
		Uses either Arabic numerals or Cyrillic alphanumerical numbering.
	\end{itemize}
\paragraph*{Commands:}
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey[1.45]{variant}{lower or \xpgpresetvalue{upper}}
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey[1.46]{variant}{\xpgpresetvalue{spanish} or mexican}
	\item \xpgchoicekey[1.46]{spanishoperators}{\xpgdefaultvalue{all}, accented,
	spaced, none, or \xpgpresetvalue{false}}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey[1.0.1]{numerals}{\xpgpresetvalue{western} (\ie 1234567890), eastern
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{numerals}{thai or \xpgpresetvalue{arabic}}
	\end{itemize}
%
...
\paragraph*{Options:}
\begin{itemize}
	\item \xpgchoicekey{numerals}{tibetan or \xpgpresetvalue{arabic}}
\end{itemize}
...
\paragraph*{Options:}
	\begin{itemize}
	\item \xpgchoicekey{date}{long or \xpgpresetvalue{short}}
	\end{itemize}
...
\begin{itemize}
	\item \DescribeMacro{[lang=]}\xpgchoicekey{lang}{\xpgpresetvalue{local}, main,
	or ⟨language⟩}
