...
\begin{tabular}{lllll}
	...
	\TX{arabic}		& \TX{english}	& japanese		& \TX{panjabi}	& tamil			\\
	\TX{armenian}	& \TX{esperanto}& kannada		& \TX{persian}	& telugu		\\
	asturian		& estonian		& khmer			& piedmontese	& \TX{thai}		\\
	basque			& \TX{finnish}	& \TX{korean}	& \TX{polish}	& \TX{tibetan}	\\
	\TX{belarusian}	& \TX{french}	& \TX{kurdish}	& \TX{portuguese}& turkish		\\
...
\begin{longtable}[c]{ll>{\raggedright}p{6cm}}
	...
	pa               & panjabi     & numerals=Gumurkhi                                  \tabularnewline
...
\subsection[panjabi]{panjabi\new{1.59}}\label{panjabi}
\paragraph*{Options:}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \Cmd\panjabinumeral produces Panjabi numbering, depending on the ¦numerals¦ option in the Panjabi language selection, this
           is either Gurmukhi of Latin (Western).
