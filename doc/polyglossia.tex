...
threshold value. This setting can be changed repeatedly in the preamble and the document body, and
it applies to all subsequent text in the respective language (variety).
