...
\begin{tabular}{lllll}
\hline
albanian     & \TX{english}    & \TX{italian}  & occitan        & tamil          \\
amharic      & \TX{esperanto}  & japanese      & piedmontese    & telugu         \\
\TX{arabic}  & estonian        & kannada       & polish         & \TX{thai}      \\
\TX{armenian}& \TX{farsi}      & khmer         & \TX{portuguese}& \TX{tibetan}   \\
asturian     & \TX{finnish}    & \TX{korean}   & romanian       & turkish        \\
basque       & \TX{french}     & \TX{kurdish}  & romansh        & turkmen        \\
\TX{bengali} & friulian         & \TX{lao}      & \TX{russian}   & \TX{ukrainian} \\
breton       & \TX{gaelic}     & \TX{latin}    & \TX{sami}      & urdu           \\
bulgarian    & galician        & latvian       & \TX{sanskrit}  & vietnamese     \\
\TX{catalan} & \TX{german}     & lithuanian    & \TX{serbian}   & \TX{welsh}     \\
coptic       & \TX{greek}      & macedonian    & slovak         &                \\
croatian     & \TX{hebrew}     & \TX{malay}    & \TX{slovenian} &                \\
czech        & \TX{hindi}      & malayalam     & \TX{sorbian}   &                \\
danish       & hungarian       & marathi       & spanish        &                \\
divehi       & icelandic       & nko           & swedish        &                \\
\TX{dutch}   & interlingua     & \TX{norwegian}& \TX{syriac} \\
\hline
\end{tabular}
