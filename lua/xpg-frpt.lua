...
texio.write_nl(table.serialize(node.types()))
...
local xpgfrptattr = tex.attribute['xpg@frpt']
            ...
            if attr and attr > 0 then
                ...
                if map then
                    ...
                    if map[1] == left and prev then
                        ...
                        insert_node_before(head,start,new_glue(map[2]*quad))
                        done = true
                    end
